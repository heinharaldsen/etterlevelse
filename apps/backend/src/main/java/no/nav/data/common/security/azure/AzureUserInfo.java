...
public class AzureUserInfo implements UserInfo {
    ...
    public AzureUserInfo(String appId, String userId, String ident, String name, String email, List<String> groups) {
        this.appId = appId;
        this.userId = userId;
        this.ident = ident;
        this.name = name;
        this.email = email;
        this.groups = convert(groups, grantedAuthority -> substringAfter(grantedAuthority, ROLE_PREFIX));
    }
